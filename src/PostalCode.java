...
public class PostalCode {
     ...
     */
    protected static final Map<Character, Integer> POSTAL_DISTRICT_CODES = new HashMap<>() {{
     ...
     */
    protected static final Map<Character, Integer> VALID_POSTAL_CODE_LETTERS = new HashMap<>() {{
        put('A',1);
        put('B',2);
        put('C',3);
        put('E',4);
